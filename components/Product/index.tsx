...
export function Product(Product: ProductProps) {
    ...
    return (
        <div className={`flex flex-col justify-around items-center h-auto w-auto m-10 border-2 bg-[#2D4654] rounded-lg hover:scale-105 delay-150 shadow-lg`} key={Math.random()} >
